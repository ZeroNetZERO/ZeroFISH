...
if not isfolder("ZeroX") then
    makefolder("ZeroX")
end
if not isfolder("ZeroX/cfg") then
    makefolder("ZeroX/cfg")
end
...
local ConfigFile = "ZeroX/cfg/zerox_" .. gameName .. ".json"
...
local ZeroX = {}
function ZeroX:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "ZeroX"
...
function zerox(msg, delay, color, title, desc)
    return ZeroX:MakeNotify({
        Title = title or "ZeroX",
...
function ZeroX:Window(GuiConfig)
    GuiConfig = GuiConfig or {}
    GuiConfig.Title = GuiConfig.Title or "ZeroX"
    GuiConfig.Footer = GuiConfig.Footer or "| Premium"
